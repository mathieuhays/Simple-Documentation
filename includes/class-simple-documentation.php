<?php
/**
 * Simple Documentation - Legacy Class
...
class Simple_Documentation extends Singleton {
	...
	public function load_textdomain() {
		load_plugin_textdomain( 'client-documentation' , false, SIMPLE_DOCUMENTATION_LANGUAGES );
	}
	...
	public function add_admin_styles() {
		...
		wp_enqueue_style( $this->slug . '_stylesheet' , plugins_url('assets/dist/css/simpledocumentation.css', SIMPLE_DOCUMENTATION_DIR . '/client-documentation.php'), false, self::VERSION );
		wp_enqueue_style('font-awesome', plugins_url('assets/dist/css/font-awesome.min.css', SIMPLE_DOCUMENTATION_DIR . '/client-documentation.php') );
	}
	...
	public function dashboard_widget(){
		include SIMPLE_DOCUMENTATION_VIEWS . '/widget.inc.php';
	}
	...
	public function page_content(){
		include SIMPLE_DOCUMENTATION_VIEWS . '/list-add-edit.inc.php';
	}
	...
	public function settings_page(){
		...
		/* Display form */
		include SIMPLE_DOCUMENTATION_VIEWS . '/settings.inc.php';
	}
	...
	public function import_export_page(){
		include SIMPLE_DOCUMENTATION_VIEWS . '/import-export.inc.php';
	}
